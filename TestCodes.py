...
while True:
    ...
    if gameOver is False:
        flipped_frame, faces = detector.findFaceMesh(flipped_frame, draw=False)

        flipped_frame = cvzone.overlayPNG(flipped_frame, currentObject, pos)
        pos[1] += speed
        ...
        if faces:
            ...
            for id in idList:
                cv2.circle(flipped_frame, face[id], 5, (255, 0, 255), 5)
            cv2.line(flipped_frame, up, down, (0, 255, 0), 3)
            cv2.line(flipped_frame, face[idList[2]], face[idList[3]], (0, 255, 0), 3)
            ...
            cv2.line(flipped_frame, (cx, cy), (pos[0] + 50, pos[1] + 50), (0, 255, 0), 3)
            ...
            if ratio > 60:
                ...
                mouthStatus = "Closed"
            cv2.putText(flipped_frame, mouthStatus, (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (255, 0, 255), 2)
            ...
            if distMouthObject < 100 and ratio > 60:
                if isEatable:
                    ...
                    gameOver = True
        cv2.putText(flipped_frame, str(count), (1100, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (255, 0, 255), 5)
    else:
        cv2.putText(flipped_frame, "Game Over", (300, 400), cv2.FONT_HERSHEY_PLAIN, 7, (255, 0, 255), 10)


    cv2.imshow("Flipped Image", flipped_frame)
    key = cv2.waitKey(1)
